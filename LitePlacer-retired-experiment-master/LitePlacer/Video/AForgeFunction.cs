...
namespace LitePlacer {
    ...
    public class AForgeFunctionSet: INotifyPropertyChanged  {
        private List<BindingList<AForgeFunction>> list = new List<BindingList<AForgeFunction>>();
        private List<string> names = new List<string>();
        private string dir = Global.BaseDirectory;
        private string type;
        ...
        public void AddMissing() {
            ...
            if (type.Equals("DOWN")) {
                types = new[] { "Homing", "Fiducials", "Components", "PaperTape", "ClearPlasticTape", "BlackPlasticTape","ComponentPhoto"};
            }
        ...
        public static List<string> GetTapeTypes() {
            string[] filenames = Directory.GetFiles(Global.BaseDirectory, "*Tape.aforgeDOWN");
    ...
    public class AForgeFunction : INotifyPropertyChanged {
        ...
        public bool Enabled {
            get { return _enabled; }
            set { _enabled = value; notify("Enabled"); }
        }
       /* public int parameter_int {
        ...
        public override string ToString() {
            return String.Format("{0},{1},{2},{3},{4},{5}", _method, parameter_double, R, G, B, Enabled);
        }
