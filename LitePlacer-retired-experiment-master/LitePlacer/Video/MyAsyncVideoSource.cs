...
// this is from the source - added to deal with some treading problems that i coudln't address with the DLL
...
namespace LitePlacer {
    class MyAsyncVideoSource: IVideoSource {
        /// <summary>
        ...
        /// 
        public MyAsyncVideoSource(IVideoSource nestedVideoSource) {
        ...
        /// 
        public MyAsyncVideoSource(IVideoSource nestedVideoSource, bool skipFramesIfBusy) {
            this.nestedVideoSource = nestedVideoSource;
